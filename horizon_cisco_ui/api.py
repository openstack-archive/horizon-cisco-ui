...
def hosting_device_delete(request, device_id):
    neutron.neutronclient(request).delete_hosting_device(device_id)
...
def hosting_device_template_delete(request, template_id):
    neutron.neutronclient(request).delete_hosting_device_template(template_id)
