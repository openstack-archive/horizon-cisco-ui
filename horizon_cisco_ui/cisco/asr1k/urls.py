...
from horizon_cisco_ui.cisco.asr1k.hosting_devices import urls\
    as hosting_devices_urls
from horizon_cisco_ui.cisco.asr1k.hosting_device_templates import urls\
    as hosting_device_templates_urls

urlpatterns = [
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^\?tab=asr1k_tabs__hosting_devices$',
        views.IndexView.as_view(), name='hosting_devices'),
    url(r'hosting_devices/', include(hosting_devices_urls,
        namespace='hosting_devices')),
    url(r'^\?tab=asr1k_tabs__hosting_device_templates$',
