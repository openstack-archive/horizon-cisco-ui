...
def get_profile(obj):
    if 'profileName' in obj:
        template_name = 'cisco/dfa/_profile_overview.html'
        context = {
            "name": obj.get('profileName'),
            "type": obj.get('profileType'),
            "description": obj.get('description')
            # "fwding_mode": obj.get('configCommands').replace("\r", "<br>")
        }
        return template.loader.render_to_string(template_name, context)
    return obj.get('profileName')
...
class CFGProfileTable(tables.DataTable):
    profile_name = tables.Column(get_profile, sortable=False,
                                 verbose_name=_("Profile Name"))
    fwding_mode = tables.Column("forwardingMode",
                                verbose_name=_("Forwarding Mode"))
...
class InstanceTable(tables.DataTable):
    ...
    port_id = tables.Column("port_id", verbose_name=_("PORT ID"))
