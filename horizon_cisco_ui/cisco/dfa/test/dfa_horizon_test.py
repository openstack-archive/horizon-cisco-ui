...
class DFATestCase(test.BaseAdminViewTests):
    ...
    def test_nfe_info_index(self):
        ...
        self.assertQuerysetEqual(
            ...
            [project.__repr__() for project in self.dfa_project.list()])

        self.assertQuerysetEqual(
            services_tab._tables['networktable'].data,
            [network.__repr__() for network in self.dfa_network.list()])
    ...
    def test_nfe_agents_index(self):
        ...
        self.assertQuerysetEqual(
            ...
            [agent.__repr__() for agent in self.dfa_agent.list()])
