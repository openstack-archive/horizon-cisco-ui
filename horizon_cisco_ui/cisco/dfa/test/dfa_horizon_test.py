...
class DFATestCase(test.BaseAdminViewTests):
    ...
    def _test_base_index(self):
        ...
        summary = self.summary.list()[0]

        with mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client.DFAClient'
                        '.get_config_profiles_detail', return_value=profiles), \
                mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                           '.DFAClient.get_network_by_tenant_id',
                           return_value=networks), \
                mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                           '.DFAClient.get_instance_by_tenant_id',
                           return_value=instances), \
                mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                           '.DFAClient.get_project_details',
                           return_value=projects), \
                mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                           '.DFAClient.get_fabric_summary',
                           return_value=summary), \
                mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                           '.DFAClient.get_agents_details',
                           return_value=agents):
    ...
    def test_fabric_summary_tab_index(self):
        ...
        self.assertEqual(
            ...
            [summary for summary in self.summary.list()[0]])
    ...
    def test_agent_detail(self):
        ...
        with mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                        '.DFAClient.get_agent_details_per_host',
                        return_value=agent):
    ...
    def test_associate_dci_to_project(self):
        ...
        with mock.patch('horizon_cisco_ui.cisco.dfa.tabs.dfa_client'
                        '.DFAClient.do_associate_dci_id_to_project'):
