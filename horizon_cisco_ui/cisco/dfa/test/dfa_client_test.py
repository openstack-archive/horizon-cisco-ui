...
class DFAClientTestCase(test.BaseAdminViewTests):
    ...
    def _test_dfa_client_init(self):
        with mock.patch('networking_cisco.apps.saf.common.rpc.DfaRpcClient') \
            as dfa_rpc, \
    ...
    def test_do_precreate_network(self):
        ...
        with mock.patch.object(self.DFAClient.clnt, 'make_msg') \
            as mock_make_msg, \
    ...
    def test_do_delete_precreate_network(self):
        network = dict(tenant_id=1,
                       nwk_name='net1',
                       subnet='10.0.0.0/24',
                       cfgp='defaultNetworkL2Profile')
        ...
        with mock.patch.object(self.DFAClient.clnt,
                ...
                mock.patch.object(self.DFAClient.clnt, 'call') as mock_call:
            self.DFAClient.do_delete_precreate_network(network)

        rpc_make_obj = mock_make_msg.return_value
        mock_make_msg.assert_called_with('delete_precreate_network', {},
                                         msg=message)
        mock_call.assert_called_with(rpc_make_obj)
