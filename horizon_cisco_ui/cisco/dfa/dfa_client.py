...
class DFAClient(object):
    ...
    def do_associate_dci_id_to_project(self, tenant):
        ...
        msg = self.clnt.make_msg('associate_dci_id_to_project',
                                 context, msg=args)
        try:
    ...
    def get_fabric_summary(self):
        ...
        context = {}
        args = json.dumps({})
        msg = self.clnt.make_msg('get_fabric_summary', context, msg=args)
        try:
            resp = self.clnt.call(msg)
            return resp
        except (rpc.MessagingTimeout, rpc.RPCException, rpc.RemoteError):
    ...
    def get_project_details(self, tenant):
        ...
        context = {}
        args = json.dumps(tenant)
        msg = self.clnt.make_msg('get_project_detail',
                                 context, msg=args)
        try:
            resp = self.clnt.call(msg)
            if not resp:
    ...
    def get_network_by_tenant_id(self, tenant):
        ...
        context = {}
        args = json.dumps(tenant)
        msg = self.clnt.make_msg('get_all_networks_for_tenant',
                                 context, msg=args)
        try:
            resp = self.clnt.call(msg)
            if resp is False:
    ...
    def get_instance_by_tenant_id(self, tenant):
        ...
        context = {}
        args = json.dumps(tenant)
        msg = self.clnt.make_msg('get_instance_by_tenant_id',
                                 context, msg=args)
        try:
            resp = self.clnt.call(msg)
            if resp is False:
    ...
    def get_agents_details(self):
        ...
        context = {}
        args = json.dumps({})
        msg = self.clnt.make_msg('get_agents_details', context, msg=args)
        try:
            resp = self.clnt.call(msg)
            if not resp:
    ...
    def get_agent_details_per_host(self, agent):
        ...
        msg = self.clnt.make_msg('get_agent_details_per_host', context,
                                 msg=args)
        try:
            resp = self.clnt.call(msg)
            if not resp:
